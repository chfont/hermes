...
impl Reminder {
	...
	return (self.frequency, self.month, self.day, self.year, self.hour, self.minute, self.n, &self.message);
    }

    pub fn new(frequency: Frequency, month: u8, day: u8, year: u32, hour: u8, minute: u8, n: Option<u32>, message: String) -> Self {
	return Reminder {
	    frequency,
	    month,
	    day,
